                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="nama_dept" id="nama_dept" placeholder="Departemen" class="form-control" value="{{ Request('nama_dept') }}">
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" value="" id="nik" class="form-control" name="kode_dept" placeholder="Kode Departemen">
                          </div>
                    </div>
                    </div>
                    <div class="row">
