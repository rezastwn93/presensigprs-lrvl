...
class PresensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($radius > $lok_kantor->radius ) {
            echo "error|Maaf Anda Berada Diluar Radius Lokasi Absen, Jarak Anda " . $radius . " meter dari Kantor|radius";
        } else {
        if ($cek > 0 ){
            $data_pulang = [
                'jam_out' => $jam,
        ...
        if($simpan){
            ...
            echo "error|Maaf Anda Gagal Absen, Harah Hubungi Admin|in";
        }
    }
}
    }
